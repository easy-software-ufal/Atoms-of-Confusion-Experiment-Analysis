...
```{r echo=FALSE, include=TRUE}
boxplot(totalTime3$Trials~totalTime3$Technique+totalTime3$Tasks,outline=F, at=c(3,4,5,6),xlim=c(0, 9), width=c(0.25,0.25,0.25,0.25),
        ylab="Tries"
        )
...
boxplot(totalTime3$Time~totalTime3$Technique+totalTime3$Tasks,outline=F,at=c(3,4,5,6), xlim=c(0, 9), ylim=c(10,100),
